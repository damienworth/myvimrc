...
vim.o.matchtime = 2 -- delay before showing matching parent
vim.o.mps = vim.o.mps .. ",<:>"
...
vim.o.wildignore = 'deps,.svn,CSV,.git,.hg,*.o,*.a,*.class,*.mo,*.la,*.so,*.obj,*.swp,*.jpg,*.png,*.xpm,*.gif,.DS_Store,*.aux,*.out,*.toc'
