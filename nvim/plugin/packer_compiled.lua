...
_G.packer_plugins = {
  ...
  ripgrep = {
    loaded = true,
    path = "/home/vlad/.local/share/nvim/site/pack/packer/start/ripgrep",
  ...
  ["vim-abolish"] = {
    loaded = true,
    path = "/home/vlad/.local/share/nvim/site/pack/packer/start/vim-abolish",
  ...
  ["vim-trailing-whitespace"] = {
    loaded = true,
    path = "/home/vlad/.local/share/nvim/site/pack/packer/start/vim-trailing-whitespace",
